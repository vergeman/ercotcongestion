...
from compute.mapping.scorecard import (
    DEFAULT_ALGO,
    DEFAULT_DEADBAND,
    DEFAULT_K,
    DEFAULT_MIN_MEMBERS,
...
from compute.regimes import BinResult, bin_hours, load_hourly_covariates
from compute.regimes.binners import parse_scheme
...
def _compare_pooled(
    ...
    reconcile (rerun ``compute.mapping.scorecard`` or re-promote), not
    ...
    if drift:
        logger.warning(
            ...
            "headline. Rerun compute.mapping.scorecard (or re-promote) to "
