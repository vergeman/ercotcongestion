"""Tests for `compute.legacy.clustering.polygons`."""
...
from compute.legacy.clustering.polygons import (
    build_polygons,
    transfer_labels,
    write_zones_geojson,
)
...
def test_singleton_clusters_are_dropped(planted, synthetic_coords, caplog):
    ...
    with caplog.at_level(logging.INFO, logger="compute.legacy.clustering.polygons"):
