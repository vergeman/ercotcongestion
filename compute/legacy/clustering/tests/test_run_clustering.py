"""Tests for `compute.legacy.clustering.runner` and `select_zones`.
...
from compute.legacy.clustering import runner as run_clustering, select_zones
...
def test_deprecated_ref_methods_flag_logs_and_ignored(sweep_inputs, caplog):
    ...
    with caplog.at_level(logging.WARNING, logger="compute.legacy.clustering.runner"):
