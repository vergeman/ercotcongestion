...
per-timestamp transforms in ``compute.legacy.transforms``.

Usage:
    docker compose run --rm compute python -m compute.legacy.matrix \\
...
from compute.legacy.congestion.compute import METHODS, compute_congestion
from compute.legacy.transforms import (
    assign_load_zones,
...
from compute.legacy.run_pipeline import _load_dates
