...
Usage:
    docker compose run --rm compute python \\
        -m compute.legacy.calibration.hub_k_sweep.sweep --start 2025-01-01 --end 2026-07-01
    docker compose run --rm compute python \\
        -m compute.legacy.calibration.hub_k_sweep.sweep \\
...
from compute.legacy.congestion.compute import CUSTOM_HUBS, HUB_BUSAVG
