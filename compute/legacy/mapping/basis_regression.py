...
`compute.legacy.mapping.correlation_map.load_matrices`) and writes:
...
Usage:
    python -m compute.legacy.mapping.basis_regression --run-id v1-120 \
...
def fit_components(
    ...
    matching `compute.legacy.congestion.pca_variance_explained`'s convention.
