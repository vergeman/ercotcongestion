...
export const CURATED_EVENTS: CuratedEvent[] = [
  {
    id: "baseline_2025_apr16",
    label: "Quiet baseline",
    description:
      "Apr 16, 2025 — mild spring afternoon. Low load, no congestion, no scarcity.",
    what_it_tests:
  ...
  },
  {
    ...
    description:
      "Jan 5, 2025 — overnight West Texas wind ramp pushing into negative LMPs.",
    what_it_tests:
    ...
    cursor_ts: "2025-01-05T08:00:00Z",
    suggested_view: "lmp",
  },
  {
    ...
    description:
      "Jan 15, 2025 — cold morning peak. Hub prices spike to ~$2,250/MWh, system-wide stress.",
    what_it_tests:
  ...
  },
  {
    ...
    label: "Rabbit Hill",
    description:
      "Feb 19, 2025 — localized line stress at the Rabbit Hill (RHESS2_ESS1) corridor.",
    what_it_tests:
  ...
  },
  {
    ...
    description:
      "May 23, 2025 — hot afternoon, heavy load, but no DC-OPF binding.",
    what_it_tests:
