...
* Refactor follow-up: resolve scorecard status copy through a dedicated UI helper rather than nested JSX conditionals.
...
* [x] Scorecard status copy is selected without nested JSX conditionals.
