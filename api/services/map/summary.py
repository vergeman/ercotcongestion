...
def build(*, overview: Callable[[], object], meta: Callable[[], object]) -> MapSummaryResponse:
    ...
    return MapSummaryResponse(topology=topology, overview=overview_result, meta=meta_result, headline=headline_result, availability={"topology": BootstrapSectionStatus(available=True), "overview": availability_status(overview_result, BootstrapSectionStatus), "meta": availability_status(meta_result, BootstrapSectionStatus), "headline": availability_status(headline_result, BootstrapSectionStatus)})
