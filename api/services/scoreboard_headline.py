...
def build_headline(run_id: str | None, regime: str) -> ScoreboardHeadline:
    ...
    return ScoreboardHeadline(run_id=run_id, regime=regime, as_of_week=as_of, windows=_windows(rows, as_of))
