...
WEEKLY_SOURCE_DEFINITIONS = (
    SourceDefinition("scoreboard_model_backtest_nodal", "model", "Walk-forward nodal forecast",
    ...
    SourceDefinition("scoreboard_climatology_backtest_nodal", "climatology", "Trailing-window nodal baseline",
                         "Hourly μ climatology projected by each backtest map."),
    SourceDefinition("scoreboard_oracle_backtest_nodal", "oracle", "Settled-μ nodal ceiling",
...
DAILY_SOURCE_DEFINITIONS = (
    SourceDefinition("scoreboard_model_served_nodal", "model", "Served nodal forecast",
    ...
    SourceDefinition("scoreboard_climatology_trailing_window_nodal", "climatology", "Trailing-window nodal baseline",
                         "Trailing-window μ climatology projected through the map."),
    SourceDefinition("scoreboard_oracle_settled_mu_nodal", "oracle", "Settled-μ nodal ceiling",
