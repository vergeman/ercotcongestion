...
def get_matrix_frame(
    ...
    row_order: str = Query(
        ...
        description="Constraint row selection order.",
    ),
    metadata: dict[str, tuple[str | None, str | None]] = Depends(
        get_settlement_point_metadata
    ),
) -> MatrixFrame:
    request = MatrixFrameRequest(
        interval_ts=coerce_utc(interval_ts),
        row_limit=row_limit,
        column_limit=column_limit,
        row_preset=row_preset,
        ...
        pinned_settlement_points=_bounded_values(
            pinned_settlement_point, name="pinned_settlement_point"
        ),
        peek_constraint=peek_constraint,
        peek_settlement_point=peek_settlement_point,
